...
import { FaEnvelope, FaGoogle, FaPhone, FaWhatsapp } from 'react-icons/fa';
...
const ContactForm = () => {
  ...
  const handleSendEmail = () => {
    ...
    const emailLink = `mailto:maxinegrey438@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(message)}`; // Construct the email link with subject and message
            ...
            {!isFormSubmitted ? (
                <form className={styles.form}>
                    ...
                    <div className={styles["input-button"]}>
                        ...
                        <Button type="button" className={styles.button} onClick={handleSendWhatsapp}> <FaWhatsapp /> Send to WhatsApp</Button>
                    </div>
                </form>
            ) : (
                <div>
