...
const EditPage = () => {
    ...
    const handleSubmit = async () => {
        try {
            let headerImageUrl = originalHeaderImageUrl;
            if (file) {
                // Delete the old image
                if (originalHeaderImageUrl) {
                    const imageRef = ref(getStorage(), originalHeaderImageUrl);
                    await deleteObject(imageRef);
                }

                headerImageUrl = await handleHeaderImageUpload();
            }
